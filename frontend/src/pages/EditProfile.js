  ...
  return (
    <div className="edit-profile-container">
      ...
      <form onSubmit={handlePhotoSubmit} className="edit-profile-form classic-photo-upload">
          <h2 className="edit-profile-title">Upload Profile Photo</h2>
        ...
        <button type="button" onClick={handleRemovePhoto} className="classic-upload-button" style={{ backgroundColor: '#dc2626', marginLeft: '0px' }}>Remove Current Photo</button>
      </form>
